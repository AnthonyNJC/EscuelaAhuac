    ...
    <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            ...
            <div class="sb-sidenav-footer">
                ...
                <%
                    Usuario userloged = (Usuario) request.getSession().getAttribute("usuarioLogeado");
                    if (userloged == null) {
                        response.sendRedirect("../loginNecesario.jsp"); // Redirigir si no hay sesión activa
                        return; // Detener el procesamiento de la página
                    }

                %>
                <%= userloged.getNombreUsuario()%>
            </div>
        </nav>
    </div>