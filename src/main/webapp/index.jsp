...
<!--llamando a la barra de menu -->
<%@include file="componentes/menuBar.jsp" %>

<!--llamando a la seccion con video -->
<%@include file="componentes/intro.jsp" %>

<!--llamando a la sobre nosotros -->
...
<%@include file="componentes/video.jsp" %>
