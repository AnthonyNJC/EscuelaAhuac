                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5" style="background: transparent; backdrop-filter: blur(20px); border-radius: 10px; padding: 30px 40px; box-shadow: 0 0 10px rgba(0, 0, 0, .2);  border: 2px solid rgba(255, 255, 255, .2);">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="row mb-3">
                                        <div class="col-md-6" >
                                            <div class="form-floating mb-3 mb-md-0">
                                                ...
                                                <label for="inputNombre">Nombre del bien</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input class="form-control" id="inputApellido" type="text" placeholder="Ingrese sus apellidos" />
                                                <label for="inputApellido">Cantidad (Solo digite Numeros)</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid"><a class="btn btn-primary btn-block" style="background: #1c1e21" href="login.html">Registrar Bien</a></div>
                                    </div>
                                </form>
                            </div>
                        </div>
