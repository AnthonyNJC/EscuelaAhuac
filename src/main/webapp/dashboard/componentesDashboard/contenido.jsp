<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Nuestra Señora de Fatima</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Gestion Integral</li>
            </ol>
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    ...
                    <img src="../assets/images/cuadrado_estudiante.jpeg" width="100%" >
                </div>
                <div class="col-xl-4 col-md-6">
                    ...
                    <img src="../assets/images/cuadrado_maestro.jpeg" width="100%" >
                </div>
                <div class="col-xl-4 col-md-6">
